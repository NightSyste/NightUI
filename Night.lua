...
function Library:MakeWindow(WindowConfig)
	...
	local function LoadSequence()
		...
		-- Haupt-Container: kompakt, zentriert, halbtransparent
		...
		local LogoIcon = Create("ImageLabel", {
			...
			BackgroundTransparency = 1,
			ImageColor3 = Color3.fromRGB(135, 206, 250),
			ImageTransparency = 1,
			ZIndex = 11
		})
		...
		-- Fortschrittsleiste Hintergrund
		...
		-- Fortschrittsleiste Fill (der blaue Balken)
		...
		for _, step in ipairs(steps) do
			...
			-- Stroke kurz aufleuchten lassen
	...
	local function BuildTab(TabConfig, ParentHolder)
		...
		if FirstTab then
			...
			TabFrame.Ico.ImageColor3 = Color3.fromRGB(135, 206, 250)
			TabFrame.Title.TextColor3 = Color3.fromRGB(135, 206, 250)
			...
			local SectionFrame = SetChildren(SetProps(MakeElement("TFrame"), {
				...
				(function()
					local line = Create("Frame", {
						...
						BackgroundColor3 = Color3.fromRGB(135, 206, 250), BorderSizePixel = 0, Parent = SectionFrame,
					})
